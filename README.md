...
The ESP32 processor is faster and has more flash memory than the Arduino. Therefore the ESP32 based Shutter Tester, allowing greater functionality, including a colour screen, flash sync testing, camera diagnostics and data logging.
...
A guide to building a suitable enclosure using a project box or optional 3d printing, are included. 
The builder can change or adapt this for their needs, or indeed not use an enclosure at all. Photos of builders different ideas are included.
...
On a new build, an authorisation code will be displayed. Send this to me via PM (Photrino is the quickest way) and a user passkey will be sent by return.
